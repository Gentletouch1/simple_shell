...
/*
 An array of arguments passed to the command.'@args' Return: The error string.
 */
...
/*
Creates an error message for shellby_alias errors.
 */
...
/*
Creates an error message for shellby_cd errors.
 */
...
/*
 Creates an error message for syntax errors.
 */
